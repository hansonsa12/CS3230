...
public class MahJongBoard extends JPanel implements MouseListener {
    ...
    private static int xBounds = 121;
    private static int yBounds = 121;
    private static int xLength = 100;
    private static int yLength = 100;
    ...
    public MahJongBoard(long randomSeed){
        ...
        t.setBounds(780,425, xBounds, yBounds);
        ...
        t.addMouseListener(this);
        t.setBounds(64,485,xBounds, yBounds);
        add(t);
        ...
        t.addMouseListener(this);
        t.setBounds(1364, 485, xBounds, yBounds);
        add(t);

        t = model.rightTileRight;
        t.addMouseListener(this);
        t.setBounds(1364 + xLength, 485, xBounds, yBounds);
        add(t);
        setVisible(true);
    }
